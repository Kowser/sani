...
facility = Facility.new(
	name: 'My Residential Care Center',
...
facility_2 = Facility.new(
	name: 'MountainView Care Facility',
...
5.times do
	EmploymentApplication.create!(
		over_18: true,
		any_shift: var = [true, false].sample,
		any_shift_text: var ? '' : Faker::Lorem.sentences(rand(2..6)).join(', '),
		overtime: [true, false].sample,
		eligible_us: true,
		accomodations: var = [true, false].sample,
		accomodations_text: var ? '' : Faker::Lorem.sentences(rand(2..6)).join(', '),
		convictions: var = [true, false].sample,
		convictions_text: !var ? '' : Faker::Lorem.sentences(rand(2..6)).join(', '),
